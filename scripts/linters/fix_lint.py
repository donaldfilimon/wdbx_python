...
def main() -> int:
    ...
    parser.add_argument(
        "--fix-unused-vars",
        action="store_true",
        help="Fix unused variables"
    )
    parser.add_argument(
        "--fix-all",
        action="store_true",
        help="Fix all linting issues"
    )
    parser.add_argument(
        "--max-length",
        type=int,
    ...
    if not any([args.fix_imports, args.fix_whitespace, args.fix_line_length, args.fix_unused_vars, args.fix_all]):
        args.fix_all = True
