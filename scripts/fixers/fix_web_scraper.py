...
def fix_indentation_issues():
    ...
    if len(lines) > 475:
        lines[475] = "        print(f\"\\033[1;31mError: Unknown configuration key: {key}\\033[0m\")\n"
    ...
    if len(lines) > 513:
        lines[513] = "            print(f\"\\033[1;31mError: Invalid value for {key}: {e}\\033[0m\")\n"
    ...
    if len(lines) > 521:
        lines[521] = "        print(f\"\\033[1;31mError: Invalid JSON format for list value for {key}\\033[0m\")\n"
    ...
    if len(lines) > 1360:
        ...
        lines[1362] = "    print(\"\\033[1m  scrape:url <url>\\033[0m - Scrape a single URL and add to the database\")\n"
        lines[1363] = "    print(\"\\033[1m  scrape:site <url> [max_pages]\\033[0m - Crawl a site starting from URL\")\n"
        lines[1364] = "    print(\"\\033[1m  scrape:list [domain]\\033[0m - List scraped URLs, optionally filtered by domain\")\n"
        lines[1365] = "    print(\"\\033[1m  scrape:status <id>\\033[0m - Show detailed status of a scraped document\")\n"
        lines[1366] = "    print(\"\\033[1m  scrape:search <query>\\033[0m - Search scraped content\")\n"
        lines[1367] = "    print(\"\\033[1m  scrape:config [key=value]\\033[0m - Configure web scraper settings\")\n"
        lines[1368] = "\n"
        lines[1369] = "    print(\"\\n\\033[1;34mWeb Scraper Configuration:\\033[0m\")\n"
    ...
    if len(lines) > 1469:
        lines[1469] = "        print(\"You can disable robots.txt checking with: scrape:config respect_robots_txt=false\")\n"
