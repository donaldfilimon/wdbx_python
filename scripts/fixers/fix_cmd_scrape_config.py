...
def fix_cmd_scrape_config():
    ...
    for i in range(len(lines)):
        if "print(\"You can disable robots.txt checking with: scrape:config" in lines[i] and "=" not in lines[i]:
            lines[i] = "        print(\"You can disable robots.txt checking with: scrape:config respect_robots_txt=false\")\n"
