...
class TestVisualizationPlugin(unittest.TestCase):
    ...
    @pytest.mark.skipif(not (HAVE_MATPLOTLIB and HAVE_NUMPY), 
                        reason="Matplotlib and/or NumPy not available")
    ...
    @pytest.mark.skipif(not (HAVE_MATPLOTLIB and HAVE_NUMPY and HAVE_SKLEARN),
    ...
    def test_tsne_visualization_command(self):
        ...
        with patch("wdbx_plugins.visualization.save_figure") as mock_save:
            ...
            # Call the t-SNE visualization command with reduced iterations for testing
            with patch("wdbx_plugins.visualization.vis_config", {"output_dir": self.output_dir, "dpi": 100}):
    ...
    def test_export_all_visualizations_command(self):
        ...
        with patch("wdbx_plugins.visualization.cmd_plot") as mock_plot, \
