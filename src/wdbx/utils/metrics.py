...
class MetricsRegistry:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "histograms": {name: histogram["values"] for name, histogram in self.histograms.items()},
...
def track_vector_operations(wdbx_core: Any) -> None:
    ...
    def patched_optimize_memory(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            logger.info(f"Memory optimization reduced memory usage by {memory_diff / 1024 / 1024:.2f} MB")
        except ImportError:
            pass
