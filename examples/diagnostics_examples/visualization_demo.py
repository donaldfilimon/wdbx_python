...
def main():
    ...
    visualizer.create_system_overview(
        output_file=system_overview_file, time_range_minutes=5, use_plotly=True, dark_mode=True
    )
    ...
    visualizer.create_system_overview(
        output_file=system_overview_file_mpl, time_range_minutes=5, use_plotly=False
    )
    ...
    visualizer.create_events_timeline(
        output_file=events_timeline_file, time_range_hours=1, use_plotly=True
    )
